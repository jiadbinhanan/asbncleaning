...
// ─── Colour tokens (apply consistently across all 3 item types) ───────────────
// COLLECT  → amber/orange tones
// STANDARD → indigo tones
// EXTRA    → purple tones
// PROVIDE  → slate/gray tones
// OK/Good  → emerald tones
// Bad/Miss → red tones
...
// variant: "collect" | "standard" | "extra" | "provide" | "ok" | "warn"
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-2 p-3">
        ...
        <StatCell label="Standard"      sublabel="Per Room"        value={item.standard_qty}                 variant="standard" />
