...
const styles = StyleSheet.create({
  ...
  bottomSection: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 20 },
        ...
        <View style={styles.content}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.invoiceTitleBox}>
              ...
              <Text style={styles.invNumber}>{invoiceNo || "N/A"}</Text>
          ...
          <View style={styles.infoSection}>
            <View style={styles.billTo}>
              ...
              <Text style={styles.billToName}>{customerName || "Customer"}</Text>
            </View>
          ...
          <View style={styles.table}>
            ...
            {items && items.map((item: any, idx: number) => (
              <View style={styles.tdRow} key={idx}>
                {/* 🚨 Empty string fallback to prevent crash */}
                <Text style={[styles.td, styles.colDesc]}>{item.description || "Service Item"}</Text>
                <Text style={[styles.td, styles.colQty]}>{item.quantity || 1}</Text>
          ...
          {/* 🚨 wrap={false} removed entirely from layout blocks */}
